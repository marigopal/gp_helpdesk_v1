...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_array(MYSQLI_BOTH)) {
        ...
        <tr>
            ...
            <td>
                <a  data-toggle="modal" data-target="#show_password_model_box" onclick="
                                $('#pass').val('<?php echo decrypt($row[13]); ?>')"><i class="fa fa-eye"></i></a>
                                <a  data-toggle="modal" data-target="#_server_renewed_model_box"
                                onclick="
                ...
                <a  data-toggle="modal" data-target="#delete_model_box_server" 
                                onclick="
